...
export const en: Dictionary = {
  ...
  finance: {
    ...
    investDesc: 'Circle shares and projects only.',
    investSharesTitle: 'Circle shares',
    investSharesBody: 'Membership shares in your circle.',
    ...
    investActiveProjectsDesc: 'Projects across your circles.',
    investStatementCta: 'Statement',
    investEmptyTitle: 'No circles yet',
    investEmptyDesc: 'Join or create a circle for shares.',
  ...
  notificationsPage: {
    ...
    emptyDesc: 'Invites, dues, and payouts show up here.',
  ...
  help: {
    title: 'Help & support',
    subtitle: 'Get help without leaving your circles.',
    circleTitle: 'Your circle officers',
    circleBody: 'Ask your admin or treasurer in Circles.',
    openCircles: 'Go to Circles',
    accountTitle: 'Account & money',
    accountBody: 'Update You. Move money from Money. Updates live in Activity.',
    openProfile: 'Open You',
    openMoney: 'Open Money',
    contactTitle: 'Contact Jameiyah',
    contactBody: 'Owner-published channels. Prefer a ticket for a tracked reply.',
    openWhatsapp: 'WhatsApp support',
    ticketTitle: 'Send a support ticket',
    ticketBody: 'Describe the issue for a tracked reply.',
...
export const sw: Dictionary = {
  ...
  finance: {
    ...
    investDesc: 'Hisa na miradi ya mduara tu.',
    investSharesTitle: 'Hisa za mduara',
    investSharesBody: 'Hisa za uanachama katika mduara wako.',
    ...
    investActiveProjectsDesc: 'Miradi katika miduara yako.',
    investStatementCta: 'Taarifa',
    investEmptyTitle: 'Bado hakuna miduara',
    investEmptyDesc: 'Jiunge au unda mduara kwa hisa.',
  ...
  notificationsPage: {
    ...
    emptyDesc: 'Mialiko, deni, na malipo yanaonekana hapa.',
  ...
  help: {
    title: 'Msaada',
    subtitle: 'Pata msaada bila kuacha miduara yako.',
    circleTitle: 'Maofisa wa mduara',
    circleBody: 'Uliza msimamizi au mhazini kwenye Miduara.',
    openCircles: 'Nenda Miduara',
    accountTitle: 'Akaunti na pesa',
    accountBody: 'Sasisha Wewe. Songesha pesa kwenye Pesa. Sasisho zipo Shughuli.',
    openProfile: 'Fungua Wewe',
    openMoney: 'Fungua Pesa',
    contactTitle: 'Wasiliana na Jameiyah',
    contactBody: 'Njia za mmiliki. Tumia tiketi kwa jibu linalofuatiliwa.',
    openWhatsapp: 'WhatsApp msaada',
    ticketTitle: 'Tuma tiketi ya msaada',
    ticketBody: 'Eleza tatizo kwa jibu linalofuatiliwa.',
