...
export const en: Dictionary = {
  ...
  finance: {
    ...
    investSharesBody: 'Buy and hold membership shares. Officers keep par value and dividends.',
    investSharesCta: 'Shares',
    investSharesJoinCta: 'Join a circle first',
    investTreasuryTitle: 'Circle projects',
    investTreasuryBody: 'Officers record land, stock, or equipment in treasury.',
    investTreasuryCta: 'Projects',
    investTreasuryBrowseCta: 'Circles',
    investTawarruqTitle: 'Partner Tawarruq',
    investTawarruqBody: 'Larger finance outside the circle pool, separate from Qard.',
    investTawarruqCta: 'Tawarruq',
    investYourCircles: 'Your circles',
    investMultiHint: 'In more than one circle? Open each for its own shares and statement.',
    investActiveProjects: 'Active circle projects',
    investActiveProjectsDesc: 'Projects across circles you belong to.',
