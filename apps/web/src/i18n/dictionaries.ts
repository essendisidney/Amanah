...
export const en: Dictionary = {
  ...
  wallet: {
    eyebrow: 'Money',
    title: 'Money',
    subtitle: 'Add, send, save, and withdraw — your Amanah Money.',
    emptyTitle: 'No Money account found',
    emptyDesc: 'A default Money account is created automatically when your profile is provisioned.',
  ...
  walletForms: {
    ...
    simulatedHint:
      'Instant demo Money credit (no M-Pesa). Use this to pay dues, fund pockets, and repay loans while testing.',
...
export const sw: Dictionary = {
  ...
  wallet: {
    eyebrow: 'Pesa',
    title: 'Pesa',
    subtitle: 'Ongeza, tuma, okoa, na toa — Pesa yako ya Amanah.',
    emptyTitle: 'Hakuna akaunti ya Pesa',
    emptyDesc: 'Akaunti chaguomsingi ya Pesa inaundwa kiotomatiki wasifu wako unapoundwa.',
