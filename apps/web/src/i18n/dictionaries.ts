...
export const sw: Dictionary = {
  ...
  finance: {
    ...
    investMultiHint: 'Fungua kila mduara kwa hisa zake.',
    investActiveProjects: 'Miradi hai ya miduara',
    investActiveProjectsDesc: 'Katika miduara yako.',
