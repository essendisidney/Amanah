    ...
    <main className="amanah-geo min-h-dvh bg-background">
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="mb-6 flex flex-wrap items-center gap-2 sm:mb-8 sm:gap-3">
          ...
          <Button asChild variant="ghost" size="sm">
            <Link href={'/sadaka' as Route}>{dict.common.sadaka}</Link>
          </Button>
          <Button asChild variant="ghost" size="sm">
            <Link href={'/zakat' as Route}>Zakat</Link>
          </Button>
        ...
        <form
          ...
          className="mt-10 max-w-md space-y-5 rounded-xl border border-border bg-card p-6"
        >
        ...
        <p className="mt-8 text-sm text-muted-foreground">
          Giving elsewhere?{' '}
          <Link href={'/sadaka' as Route} className="text-accent underline-offset-4 hover:underline">
            Sadaka campaigns
          </Link>
          {' · '}
          <Link href={'/zakat' as Route} className="text-accent underline-offset-4 hover:underline">
            Zakat calculator
          </Link>
        </p>
      </div>
