-- Officers can void mistaken one-off book / share / loan ledger lines.
...
BEGIN
  ...
  IF v_kind NOT IN ('book_entry', 'share_lot', 'loan_event') THEN
  ...
  IF v_kind = 'book_entry' THEN
    ...
    -- Prefer voiding the parent loan event so facility balance stays correct.
