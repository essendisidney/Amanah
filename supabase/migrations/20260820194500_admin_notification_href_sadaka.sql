-- Embed deep-link href on admin Sadaka review notifications.
...
BEGIN
  ...
  INSERT INTO public.charity_campaigns (
    ...
    'pending_review', false, 'donation_addon', 250, v_uid, v_cat,
...
SET data = COALESCE(data, '{}'::jsonb) || jsonb_build_object('href', '/admin/sadaka')
WHERE title = 'Sadaka campaign pending review'
  AND (data->>'href') IS NULL;
